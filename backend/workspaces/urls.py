...
urlpatterns = [
    ...
    path('workspaces/invitations/accept/<uuid:token>/', views.accept_invite, name='accept-invitation'),
    ...
    path('invitations/<uuid:token>/accept/', views.accept_invite, name='accept-invite'), 
